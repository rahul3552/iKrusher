 ...
 */
class OrderDetails extends \Magento\Backend\Block\Widget\Grid\Extended
{
    const HEADER = 'header';
    const WIDTH = 'width';
    const INDEX = 'index';
    ...
    {
        parent::_construct();
        $this->setId('billpay_orderdetails_grid');
