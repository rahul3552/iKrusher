...
namespace Mageplaza\AdminPermissions\Plugin\Sales\Model\ResourceModel\Order\Grid;

use Mageplaza\AdminPermissions\Plugin\Sales\Model\ResourceModel\AbstractCollection;

/**
 * Class Collection
 * @package Mageplaza\AdminPermissions\Plugin\Sales\Model\ResourceModel\Order\Grid
 */
class Collection extends AbstractCollection
{
    ...
    public function beforeLoad(
        ...
        if (!$this->helperData->isAllow('Magento_Sales::actions_view')) {
