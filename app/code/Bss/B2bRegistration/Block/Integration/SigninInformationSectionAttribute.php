 ...
 *
 * @package Bss\Bss_B2bRegistration\Block\Integration
 */
class SigninInformationSectionAttribute extends \Magento\Customer\Block\Form\Register
{
    /**
     * @var ConfigFactory
     */
    ...
    /**
     * SigninInformationSectionAttribute constructor.
    ...
    public function isShowIn($attributeCode)
    {
        ...
        if (in_array('signin_infor_section', $usedInForms) && in_array('b2b_account_create', $usedInForms)) {
            return true;
        }
        return false;
    }
