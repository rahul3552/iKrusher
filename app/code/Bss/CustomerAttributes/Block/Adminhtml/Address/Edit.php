 ...
 */
namespace Bss\CustomerAttributes\Block\Adminhtml\Address;

/**
 * Class Edit
 *
 * @package Bss\CustomerAttributes\Block\Adminhtml\Address
 */
class Edit extends \Magento\Backend\Block\Widget\Form\Container
{
     ...
     * @var string
     */
    protected $_blockGroup = 'Bss_CustomerAttributes';
    ...
    protected function _construct()
    {
        ...
        if (!$entityAttribute || !$entityAttribute->getIsUserDefined()
                || !$this->_isAllowedAction('Bss_CustomerAttributes::attribute_delete')) {
            $this->buttonList->remove('delete');
        } else {
            $this->buttonList->update('delete', 'label', __('Delete Address Attribute'));
        }
        if ((!$this->_isAllowedAction('Bss_CustomerAttributes::save')) ||
    ...
    {
        return $this->getUrl('customerattribute/*/validate', ['_current' => true]);
    }
}
