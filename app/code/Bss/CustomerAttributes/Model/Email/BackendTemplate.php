...
class BackendTemplate extends \Magento\Email\Model\BackendTemplate
{
    ...
    public function getVariablesOptionArray($withGroup = false)
    {
        ...
        $variables['var bss_billing_address_attributes'] = __('Order Custom Billing Address');
        $variables['var bss_shipping_address_attributes'] = __('Order Custom Shipping Address');
