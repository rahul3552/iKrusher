...
class Collection extends SearchResult
{
    ...
    protected function _initSelect()
    {
        ...
        $this->getSelect()
            ...
            ->where('eav_attribute.entity_type_id =1')
            ->where('eav_attribute.attribute_code != "b2b_activasion_status"')
            ->where('eav_attribute.attribute_code != "bss_is_company_account"')
            ->where('eav_attribute.attribute_code != "b2b_normal_customer_group"');
    }
