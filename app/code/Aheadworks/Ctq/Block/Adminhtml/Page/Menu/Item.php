 ...
 */
namespace Aheadworks\Ctq\Block\Adminhtml\Page\Menu;

use Aheadworks\Ctq\Block\Adminhtml\Page\Menu;
 ...
 *
 * @package Aheadworks\Ctq\Block\Adminhtml\Page\Menu
 */
class Item extends Template
{
     ...
     * @var string
     */
    protected $_template = 'Aheadworks_Ctq::page/menu/item.phtml';
