...
class SellerQuoteServiceTest extends TestCase
{
    ...
    public function testCreateQuote()
    {
        ...
        $quoteMock = $this->getMockBuilder(Quote::class)
            ...
            ->setMethods(['setCustomerId', 'setIsSeller', 'setStatus'])
            ->getMock();
    ...
    public function testUpdateQuote()
    {
        $quoteMock = $this->getMockBuilder(Quote::class)
            ->disableOriginalConstructor()
            ->setMethods(['setIsSeller', 'getCartId'])
            ->getMock();
        $quoteMock->expects($this->once())
            ->method('setIsSeller')
            ->with(true)
    ...
    public function testCopyQuote()
    {
        ...
        $copiedCartMock = $this->getMockBuilder(MagentoQuote::class)
            ->disableOriginalConstructor()
            ->setMethods(['setAwCtqSellerId', 'setIsActive'])
            ->getMock();
        $quoteMock = $this->createPartialMock(Quote::class, ['getStoreId', 'getCart', 'getSellerId']);
        $copiedQuoteMock = $this->getMockBuilder(Quote::class)
            ->disableOriginalConstructor()
            ->setMethods(['setIsSeller', 'setStatus', 'setReminderDate', 'setExpirationDate', 'setReminderStatus'])
            ->getMock();
