 ...
 */
namespace Aheadworks\CreditLimit\Block\Adminhtml\Page\Menu;

use Magento\Backend\Block\Template;
use Aheadworks\CreditLimit\Block\Adminhtml\Page\Menu;
 ...
 *
 * @package Aheadworks\CreditLimit\Block\Adminhtml\Page\Menu
 */
class Item extends Template
{
     ...
     * @inheritdoc
     */
    protected $_template = 'Aheadworks_CreditLimit::page/menu/item.phtml';
